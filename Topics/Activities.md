...
Похоже, применяя десь мы не провели границу между отображением view и логикой работы с нашими объектами – вещь, которая приспособлена для одной цели получается не приспособлена для другой. Вспомним [Single Responsibility Principle](http://blog.codinghorror.com/curlys-law-do-one-thing/)

Видно что логически управление экраном и управление логикой работы приложения должны относится к разным объектам. Давайте попробуем набросать как все может выглядеть если у нас есть два разных объекта. 
